        ...
        {isLargerThanHD ? (
            ...
            >
              <Flex alignItems={"center"} gap={10}>
                ...
                >
                  ...
                  <Input placeholder="Search" value={inputData} onChange={handleChange}/>
                  <button onClick={handleSubmit} style={{fontSize:"15px", paddingLeft:"0.5rem", paddingRight:"0.5rem" }}>Search</button>
          ...
          <Box bg="#2874f0">
            ...
            <Collapse in={isOpen} animateOpacity>
              ...
              >
                <InputGroup>
                <Input placeholder="Search" value={inputData} onChange={handleChange} backgroundColor="white" color="black"/>
                  <button onClick={handleSubmit} style={{fontSize:"15px", paddingLeft:"0.5rem", paddingRight:"0.5rem", backgroundColor:"white", color:"black", borderRadius:"5px"}}>Search</button>
                </InputGroup>
